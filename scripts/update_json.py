...
generate_plate_json(base_dir,output_folder + '\\plate_names.json')

# Update the state page JSON file
generate_state_page_json(base_dir, output_folder + '\\state_license_index.json')

# Update the first image JSON file
first_image(base_dir, output_folder + '\\first_image_index.json')